module.exports = {
  ...
  body: p => {
    ...
    // B.SilkS
    fp.push(`(fp_line (start ${(flip ? 6.6 : -6.6)} -7.45) (end ${(flip ? 6.6 : -6.6)} -4.45) (stroke (width 0.1) (type default)) (layer ${(flip ? "F.SilkS" : "B.SilkS")}))`);
    fp.push(`(fp_line (start ${(flip ? 6.6 : -6.6)} 7.84) (end ${(flip ? 6.6 : -6.6)} 10.84) (stroke (width 0.1) (type default)) (layer ${(flip ? "F.SilkS" : "B.SilkS")}))`);
    fp.push(`(fp_line (start ${(flip ? 6.6 : -6.6)} 10.84) (end ${(flip ? 3.6 : -3.6)} 10.84) (stroke (width 0.1) (type default)) (layer ${(flip ? "F.SilkS" : "B.SilkS")}))`);
    fp.push(`(fp_line (start ${(flip ? 3.6 : -3.6)} -7.45) (end ${(flip ? 6.6 : -6.6)} -7.45) (stroke (width 0.1) (type default)) (layer ${(flip ? "F.SilkS" : "B.SilkS")}))`);
    fp.push(`(fp_line (start ${(flip ? -3.6 : 3.6)} 10.84) (end ${(flip ? -6.6 : 6.6)} 10.84) (stroke (width 0.1) (type default)) (layer ${(flip ? "F.SilkS" : "B.SilkS")}))`);
    fp.push(`(fp_line (start ${(flip ? -6.6 : 6.6)} -7.45) (end ${(flip ? -3.6 : 3.6)} -7.45) (stroke (width 0.1) (type default)) (layer ${(flip ? "F.SilkS" : "B.SilkS")}))`);
    fp.push(`(fp_line (start ${(flip ? -6.6 : 6.6)} -4.45) (end ${(flip ? -6.6 : 6.6)} -7.45) (stroke (width 0.1) (type default)) (layer ${(flip ? "F.SilkS" : "B.SilkS")}))`);
    fp.push(`(fp_line (start ${(flip ? -6.6 : 6.6)} 10.84) (end ${(flip ? -6.6 : 6.6)} 7.84) (stroke (width 0.1) (type default)) (layer ${(flip ? "F.SilkS" : "B.SilkS")}))`);

    fp.push(`(fp_text user "Trackpoint" (at 0 7.5 ${p.r + 0}) (unlocked yes) (layer ${(flip ? "F.SilkS" : "B.SilkS")}) (effects (font (size 1 1) (thickness 0.15)) (justify bottom${ flip ? "" : " mirror"})))`);
    fp.push(`(fp_text user "Sensor" (at 0 9 ${p.r + 0}) (unlocked yes) (layer ${(flip ? "F.SilkS" : "B.SilkS")}) (effects (font (size 1 1) (thickness 0.15)) (justify bottom${ flip ? "" : " mirror"})))`);
